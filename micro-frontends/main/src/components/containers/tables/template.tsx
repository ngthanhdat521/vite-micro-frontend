...
export const AdvanceTable2: FC<IProps> = (props) => {
			...
			<div className="w-full">
				<div className=" bg-gray-50 relative shadow-md sm:rounded-lg overflow-hidden">
					<div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
						...
						<div className="w-1/3 flex flex-col md:flex-row items-stretch md:items-center justify-end flex-shrink-0 gap-5">
							<button
								type="button"
					...
					<div className="overflow-x-auto">
						<table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
							<thead className="bg-white text-xs text-gray-700 uppercase dark:bg-gray-700 dark:text-gray-400">
								<tr>
